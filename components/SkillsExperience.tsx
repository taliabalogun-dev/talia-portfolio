  ...
  return (
    <section id="skills" className="bg-beige py-16 sm:py-20">
      <div className="mx-auto max-w-5xl px-6">
        <div className="relative -rotate-[0.4deg] rounded-md bg-[#1c1815] shadow-2xl">
          <span className="font-hand absolute -top-4 left-8 -rotate-3 rounded-sm bg-accent px-4 py-1.5 text-lg text-hero-ink shadow-lg">
